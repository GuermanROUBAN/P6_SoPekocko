...
usersLiked: { type: [String], required: true, default:[] },// "tableau d'identifiants d'utilisateurs ayant aimé la sauce",
usersDisliked:{ type: [String], required: true, default:[]  },//"tableau d'identifiants d'utilisateurs n'ayant pas aimé la sauce"title: { type: String, required: true },
});
